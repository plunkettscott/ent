...
// SetNewUniqueInt sets the "unique_int" field to the value that was provided on create.
func (u *CommentUpsert) SetNewUniqueInt() *CommentUpsert {
...
// SetNewUniqueFloat sets the "unique_float" field to the value that was provided on create.
func (u *CommentUpsert) SetNewUniqueFloat() *CommentUpsert {
...
func (u *CommentUpsert) SetNewNillableInt() *CommentUpsert {
